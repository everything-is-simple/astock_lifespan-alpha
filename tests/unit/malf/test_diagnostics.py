...
def test_malf_day_real_data_diagnostics_writes_report(monkeypatch, tmp_path):
    ...
    _write_stock_adjusted_bars(
        ...
        [
            ...
            ("AAA", "2026-01-03", 10.8, 12.2, 10.1, 12.0),
            ("BBB", "2026-01-02", 20.0, 20.5, 19.8, 20.1),
            ("BBB", "2026-01-03", 20.1, 21.0, 19.9, 20.8),
        ],
    )
...
def _write_stock_adjusted_bars(database_path: Path, rows: list[tuple[str, str, float, float, float, float]]) -> None:
    import duckdb
